...
<head>
    ...
    <title>Coffe Shop | Register</title>
...
<body>
    <div class="min-h-screen flex flex-col justify-center items-center">
        <svg class="w-[60px] h-[60px] text-blue-700 dark:text-white" aria-hidden="true"
        ...
        <form action="{{ route('customer.register') }}" method="POST"
            class="w-full sm:max-w-lg bg-white p-6 rounded-lg shadow-lg">
            @csrf
            ...
            <div class="flex items-center justify-end mt-5">
                <p class="me-3 text-sm text-gray-600">
                    Already have account?
                    <a href="{{ route('customers-login') }}" class="text-blue-600 underline dark:text-blue-500">
                        Log in
                    </a>
                </p>
                <button type="submit"
