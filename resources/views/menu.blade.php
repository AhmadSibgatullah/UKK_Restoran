        ...
        <div class="mx-auto grid max-w-screen-xl px-4 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-16 xl:gap-0">
            <div class="content-center justify-self-start md:col-span-7 md:text-start">
                <h1
                    ...
                    FLASH SALE <span class="text-blue-700">9.9</span>
                </h1>
                <h1
                    class="mb-4 text-4xl font-extrabold leading-none tracking-tight dark:text-white md:max-w-2xl md:text-5xl xl:text-6xl">
                ...
                <a href="#"
                    class="inline-flex items-center justify-center rounded-lg bg-orange-700 px-5 py-3 text-center text-base font-medium text-white hover:bg-orange-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-orange-900">
                    Pesan Sekarang
                </a>
            </div>
